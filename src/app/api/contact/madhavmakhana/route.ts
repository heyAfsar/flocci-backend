...
export async function POST(req: NextRequest) {
  try {
    ...
    const madhavMakahanaEmail = process.env.madhavMakahanaEmail;
    
    if (!madhavMakahanaEmail) {
      console.error("madhavMakahanaEmail environment variable is not set");
    ...
    await transporter.sendMail(mailOptions(madhavMakahanaEmail, `New Message from ${name}`, emailHtml));
