...
export async function POST(req: NextRequest) {
    try {
        ...
        const { to, name, email, phone, message } = parseResult.data;
      ...
      <p><strong>App:</strong> ${appDomain}</p>
    ...
    `;
        ...
        await transporter.sendMail(mailOptions(to, `New Message from ${name}`, emailHtml));
